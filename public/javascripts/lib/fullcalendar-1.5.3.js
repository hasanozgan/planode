...
//TODO: when calendar's date starts out on a weekend, shouldn't happen
    ...
    function ListView(element, calendar, viewName) {
        ...
        function buildSkeleton(maxRowCnt) {
            ...
            for (i=0; i<maxRowCnt; i++) {
                    s +=
                        "<tr>" +
                            "<td class='fc- fc-day" + (i*colCnt) + "'>" + // need fc- for setDayID
                                "<div>" +
    ...
    function AgendaListView(element, calendar) {
        ...
        // imports
        ListView.call(t, element, calendar, 'agenda');
        var opt = t.opt;
        ...
        function render(date, delta) {
            ...
            var end = addDays(cloneDate(start), 15);
            var visStart = cloneDate(start);
            var visEnd =  addDays(cloneDate(end), 15);
