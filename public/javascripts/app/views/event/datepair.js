...
define([
    ...
    var DatePairView = Backbone.View.extend({



        update_timepair: function(target, container) {
        ...
        update_datepair: function(target, container) {
        ...
        render: function() {
            ...
            $('.datepair div input.date').each(function(){
                var $this = $(this);
                ...
                if ($this.hasClass('start') || $this.hasClass('end')) {
                    opts.onSelect = function() {
                                        ...
                                        parent.update_datepair(target, container);
                                    };
                }
            ...
            $('.datepair div input.time').each(function() {
                var $this = $(this);
                ...
                if ($this.hasClass('start') || $this.hasClass('end')) {
                    opts.onSelect = function() {
                        var target = $(this);
                        var container = target.closest('.datepair');
                        parent.update_timepair(target, container);
                    };
                }
